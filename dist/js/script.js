...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_6__["openModal"])('.modal', modalTimerId);
  }, 50000);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2021-08-06');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_6__["default"])('[data-modal]', '.modal', modalTimerId);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])('form', modalTimerId);
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_8__["default"])({
...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getResourse"])('http://localhost:3000/menu') // с помощью конструктора
  .then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // массив в json

      Object(_services_services__WEBPACK_IMPORTED_MODULE_10__["postData"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_9__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_9__["closeModal"])('.modal');
    }, 4000);
  }
}
...
function slider(_ref) {
  ...
  if (slides.length < 10) {
    ...
    current.textContent = "".concat(slideIndex);
  }
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      var offset = deleteNotDigits(width) * (slides.length - 1);
      changeSlide();
    });
  });
}
...
var getResourse = /*#__PURE__*/function () {
  ...
  return function getResourse(_x3) {
