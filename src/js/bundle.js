...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getResourse)('http://localhost:3000/menu') // с помощью конструктора
  .then(function (data) {
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_6__.openModal)('.modal', modalTimerId);
  }, 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-08-06');
