...
function cards() {
	...
	(0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResourse)('http://localhost:3000/menu')                // с помощью конструктора
	.then(data => {
...
window.addEventListener('DOMContentLoaded', () => {
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__.default)('.timer', '2021-08-06');
